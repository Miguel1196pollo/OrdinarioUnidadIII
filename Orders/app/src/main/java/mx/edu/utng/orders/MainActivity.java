    ...
    public class DataTaskTest extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                // Insert platform
                String platform1 = data.insertPlatforms(
                        new Platform(null, "jpogog", "Matrix Recargado"));
                String platform2 = data.insertPlatforms(
                        new Platform(null, "jptotot", "Guerra Mundial Z"));
            ...
            Log.d("Platforms","Platforms");
            DatabaseUtils.dumpCursor(data.getPlatforms());
